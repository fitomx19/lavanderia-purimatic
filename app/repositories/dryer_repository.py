...
class DryerRepository(BaseRepository):
    """
    Repositorio para secadoras con operaciones UPSERT
    """
    
    def __init__(self):
        super().__init__('dryers')
        self.create_indexes()
    
    def _get_unique_filter(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Obtener filtro basado en campos únicos para secadoras
        
        Args:
            data: Datos de la secadora
    ...
    def find_by_numero_and_store(self, numero: int, store_id: str) -> Optional[Dict[str, Any]]:
        """
        Encontrar secadora por número y tienda
        
        Args:
            numero: Número de la secadora
            store_id: ID de la tienda
            
        Returns:
            Dict: Secadora encontrada o None
        """
    ...
    def find_by_store(self, store_id: str, page: int = 1, per_page: int = 10) -> Dict[str, Any]:
        """
        Encontrar secadoras por tienda
        ...
        Returns:
            Dict: Secadoras encontradas con información de paginación
        """
    ...
    def find_by_estado(self, estado: str, store_id: Optional[str] = None, page: int = 1, per_page: int = 10) -> Dict[str, Any]:
        """
        Encontrar secadoras por estado
        
        Args:
            estado: Estado de la secadora
            store_id: ID de la tienda (opcional)
            page: Página actual
            per_page: Elementos por página
            
        Returns:
            Dict: Secadoras encontradas
        """
    ...
    def find_available_dryers(self, store_id: str, page: int = 1, per_page: int = 10) -> Dict[str, Any]:
        """
        Encontrar secadoras disponibles por tienda
    ...
    def update_estado(self, dryer_id: str, estado: str) -> Optional[Dict[str, Any]]:
        ...
        Returns:
            Dict: Secadora actualizada o None
        """
        updated_data = {
            '_id': dryer_id,
            'estado': estado
    ...
    def numero_exists_in_store(self, numero: int, store_id: str, exclude_id: Optional[str] = None) -> bool:
        """
        Verificar si el número de secadora ya existe en la tienda
        
        Args:
            numero: Número de secadora
            store_id: ID de la tienda
